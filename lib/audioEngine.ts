...
export class AudioEngine {
  ...
  start() {
    ...
    const melody = [130.8, 155.6, 174.6, 196, 174.6, 155.6, 130.8, 123.5]
    let i = 0
    const playNote = () => {
      ...
      g.gain.linearRampToValueAtTime(0.025, this.ctx.currentTime + 0.4)
      g.gain.linearRampToValueAtTime(0, this.ctx.currentTime + 2.8)
      osc.connect(g)
